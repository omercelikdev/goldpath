...
| [specanchor-composition](specanchor-composition.md) | specanchor (separate repo) — the transformation package's deterministic core, composed per foundation §9/§5.1 | **proposed** — owner decision pending; the toolchain itself is real ([qorpe/specanchor](https://github.com/qorpe/specanchor), Apache-2.0) and its composition proof is `open-threads.md` T20 (the rehearsal) |
