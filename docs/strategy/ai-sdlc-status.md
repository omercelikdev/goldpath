...
| Operations | admin APIs + ops packs + console (§7.1) | Admin APIs + dashboards + runbooks **SHIPPED-PROVEN** per module; console **PARTIAL** (U1–U2 met; U3's bulk intake, campaign governor and notification evidence panels proven in the nightly console smoke, archival open) | admin contract frozen + integration proofs | console phases U1–U4 |
