...
| add feature | 🟢 PROVEN by the nightly `GmGrown` shape (five recipes on a lean app; green 2026-09-05) — not yet in a SAMPLE | Insurance generates LEAN, then `add feature notification` — the verb proven in anger |
