...
check "spec_validate clean (schema + rules)"             "specdrift validate '$APP/.goldpath/manifest.yaml' --schema '$ROOT/schemas/manifest/v1/goldpath-manifest.schema.json' --rules '$APP/.specdrift/rules.yaml'"
check "spec_drift clean (contract re-exported)"          "specdrift drift --repo '$APP'"
