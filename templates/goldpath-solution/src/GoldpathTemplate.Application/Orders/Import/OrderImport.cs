using Goldpath;
using GoldpathTemplate.Application.Orders;

namespace GoldpathTemplate.Application.Orders.Import;
...
/// </summary>
public sealed class OrderImportHandler(IOrdersDbContext db) : IGoldpathBulkRowHandler<OrderImportRow>
{
    /// <inheritdoc />
